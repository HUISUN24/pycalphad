...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [],
        "language": "c++",
        "name": "pycalphad.core.hyperplane",
        "sources": [
            "pycalphad/core/hyperplane.pyx"
        ]
    },
    "module_name": "pycalphad.core.hyperplane"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pycalphad__core__hyperplane
#define __PYX_HAVE_API__pycalphad__core__hyperplane
/* Early includes */
#include <string.h>
#include <stdio.h>
...
/* Module declarations from 'pycalphad.core.hyperplane' */
...
static double __pyx_f_9pycalphad_4core_10hyperplane_hyperplane(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_9pycalphad_4core_10hyperplane_solve(double *, int, double *, int *); /*proto*/
static double __pyx_f_9pycalphad_4core_10hyperplane__min(double *, int); /*proto*/
static int __pyx_f_9pycalphad_4core_10hyperplane_argmax(double *, int); /*proto*/
...
#define __Pyx_MODULE_NAME "pycalphad.core.hyperplane"
extern int __pyx_module_is_main_pycalphad__core__hyperplane;
int __pyx_module_is_main_pycalphad__core__hyperplane = 0;

/* Implementation of 'pycalphad.core.hyperplane' */
...
static const char __pyx_k_total_moles[] = "total_moles";
static const char __pyx_k_compositions[] = "compositions";
static const char __pyx_k_pyx_checksum[] = "__pyx_checksum";
static const char __pyx_k_stringsource[] = "stringsource";
static const char __pyx_k_pyx_getbuffer[] = "__pyx_getbuffer";
static const char __pyx_k_reduce_cython[] = "__reduce_cython__";
static const char __pyx_k_result_simplex[] = "result_simplex";
static const char __pyx_k_View_MemoryView[] = "View.MemoryView";
static const char __pyx_k_allocate_buffer[] = "allocate_buffer";
static const char __pyx_k_dtype_is_object[] = "dtype_is_object";
static const char __pyx_k_pyx_PickleError[] = "__pyx_PickleError";
static const char __pyx_k_setstate_cython[] = "__setstate_cython__";
static const char __pyx_k_result_fractions[] = "result_fractions";
static const char __pyx_k_pyx_unpickle_Enum[] = "__pyx_unpickle_Enum";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_fixed_comp_indices[] = "fixed_comp_indices";
static const char __pyx_k_strided_and_direct[] = "<strided and direct>";
static const char __pyx_k_chemical_potentials[] = "chemical_potentials";
static const char __pyx_k_strided_and_indirect[] = "<strided and indirect>";
static const char __pyx_k_contiguous_and_direct[] = "<contiguous and direct>";
static const char __pyx_k_fixed_chempot_indices[] = "fixed_chempot_indices";
...
static PyObject *__pyx_n_s_chemical_potentials;
...
static PyObject *__pyx_n_s_fixed_chempot_indices;
static PyObject *__pyx_n_s_fixed_comp_indices;
...
static PyObject *__pyx_n_s_result_fractions;
static PyObject *__pyx_n_s_result_simplex;
...
static PyObject *__pyx_n_s_total_moles;
static PyObject *__pyx_kp_s_unable_to_allocate_array_data;
static PyObject *__pyx_kp_s_unable_to_allocate_shape_and_str;
static PyObject *__pyx_n_s_unpack;
static PyObject *__pyx_n_s_update;
static PyObject *__pyx_pf_9pycalphad_4core_10hyperplane_hyperplane(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_compositions, __Pyx_memviewslice __pyx_v_energies, __Pyx_memviewslice __pyx_v_composition, __Pyx_memviewslice __pyx_v_chemical_potentials, double __pyx_v_total_moles, __Pyx_memviewslice __pyx_v_fixed_chempot_indices, __Pyx_memviewslice __pyx_v_fixed_comp_indices, __Pyx_memviewslice __pyx_v_result_fractions, __Pyx_memviewslice __pyx_v_result_simplex); /* proto */
...
/* "pycalphad/core/hyperplane.pyx":10
 * 
...
static void __pyx_f_9pycalphad_4core_10hyperplane_solve(double *__pyx_v_A, int __pyx_v_N, double *__pyx_v_x, int *__pyx_v_ipiv) {
  int __pyx_v_i;
  int __pyx_v_info;
  int __pyx_v_NRHS;
  int __pyx_t_1;
  ...
  /* "pycalphad/core/hyperplane.pyx":12
 * cdef void solve(double* A, int N, double* x, int* ipiv) nogil:
 *     cdef int i
 *     cdef int info = 0             # <<<<<<<<<<<<<<
 *     cdef int NRHS = 1
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":13
 *     cdef int i
 *     cdef int info = 0
 *     cdef int NRHS = 1             # <<<<<<<<<<<<<<
 *     cython_lapack.dgesv(&N, &NRHS, A, &N, ipiv, x, &N, &info)
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":14
 *     cdef int info = 0
 *     cdef int NRHS = 1
 *     cython_lapack.dgesv(&N, &NRHS, A, &N, ipiv, x, &N, &info)             # <<<<<<<<<<<<<<
 *     # Special for our case: singular matrix results get set to a special value
 *     if info != 0:
 */
  __pyx_f_5scipy_6linalg_13cython_lapack_dgesv((&__pyx_v_N), (&__pyx_v_NRHS), __pyx_v_A, (&__pyx_v_N), __pyx_v_ipiv, __pyx_v_x, (&__pyx_v_N), (&__pyx_v_info));

  /* "pycalphad/core/hyperplane.pyx":16
 *     cython_lapack.dgesv(&N, &NRHS, A, &N, ipiv, x, &N, &info)
 *     # Special for our case: singular matrix results get set to a special value
 *     if info != 0:             # <<<<<<<<<<<<<<
 *         for i in range(N):
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":17
 *     # Special for our case: singular matrix results get set to a special value
 *     if info != 0:
 *         for i in range(N):             # <<<<<<<<<<<<<<
 *             x[i] = -1e19
 ...
 */
    ...
    for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":18
 *     if info != 0:
 *         for i in range(N):
 *             x[i] = -1e19             # <<<<<<<<<<<<<<
 * 
...
/* "pycalphad/core/hyperplane.pyx":22
 * 
 * @cython.boundscheck(False)
...
static void __pyx_f_9pycalphad_4core_10hyperplane_prodsum(__Pyx_memviewslice __pyx_v_chempots, __Pyx_memviewslice __pyx_v_points, __Pyx_memviewslice __pyx_v_result) {
  ...
  /* "pycalphad/core/hyperplane.pyx":23
 * @cython.boundscheck(False)
 * cdef void prodsum(double[::1] chempots, double[:,::1] points, double[::1] result) nogil:
 *     for i in range(chempots.shape[0]):             # <<<<<<<<<<<<<<
 *         for j in range(result.shape[0]):
 ...
 */
  __pyx_t_1 = (__pyx_v_chempots.shape[0]);
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pycalphad/core/hyperplane.pyx":24
 * cdef void prodsum(double[::1] chempots, double[:,::1] points, double[::1] result) nogil:
 *     for i in range(chempots.shape[0]):
 *         for j in range(result.shape[0]):             # <<<<<<<<<<<<<<
 *             result[j] -= chempots[i]*points[j,i]
 * 
 */
    __pyx_t_4 = (__pyx_v_result.shape[0]);
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6+=1) {
      __pyx_v_j = __pyx_t_6;

      /* "pycalphad/core/hyperplane.pyx":25
 *     for i in range(chempots.shape[0]):
 *         for j in range(result.shape[0]):
 *             result[j] -= chempots[i]*points[j,i]             # <<<<<<<<<<<<<<
 * 
 ...
 */
      __pyx_t_7 = __pyx_v_i;
      if (__pyx_t_7 < 0) __pyx_t_7 += __pyx_v_chempots.shape[0];
      __pyx_t_8 = __pyx_v_j;
      __pyx_t_9 = __pyx_v_i;
      ...
      *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_result.data) + __pyx_t_10)) )) -= ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chempots.data) + __pyx_t_7)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_points.data + __pyx_t_8 * __pyx_v_points.strides[0]) )) + __pyx_t_9)) ))));
    }
  }
...
/* "pycalphad/core/hyperplane.pyx":29
 * 
 * @cython.boundscheck(False)
...
static double __pyx_f_9pycalphad_4core_10hyperplane__min(double *__pyx_v_a, int __pyx_v_a_shape) {
  int __pyx_v_i;
  ...
  /* "pycalphad/core/hyperplane.pyx":31
 * cdef double _min(double* a, int a_shape) nogil:
 *     cdef int i
 *     cdef double result = 1e300             # <<<<<<<<<<<<<<
 ...
 *         if a[i] < result:
 */
  __pyx_v_result = 1e300;

  /* "pycalphad/core/hyperplane.pyx":32
 *     cdef int i
 *     cdef double result = 1e300
 *     for i in range(a_shape):             # <<<<<<<<<<<<<<
 *         if a[i] < result:
 *             result = a[i]
 */
  __pyx_t_1 = __pyx_v_a_shape;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pycalphad/core/hyperplane.pyx":33
 *     cdef double result = 1e300
 *     for i in range(a_shape):
 *         if a[i] < result:             # <<<<<<<<<<<<<<
 *             result = a[i]
 *     return result
 */
    __pyx_t_4 = (((__pyx_v_a[__pyx_v_i]) < __pyx_v_result) != 0);
    if (__pyx_t_4) {

      /* "pycalphad/core/hyperplane.pyx":34
 *     for i in range(a_shape):
 *         if a[i] < result:
 *             result = a[i]             # <<<<<<<<<<<<<<
 *     return result
 * 
 */
      __pyx_v_result = (__pyx_v_a[__pyx_v_i]);
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":35
 *         if a[i] < result:
 *             result = a[i]
 *     return result             # <<<<<<<<<<<<<<
 * 
...
/* "pycalphad/core/hyperplane.pyx":38
 * 
 * @cython.boundscheck(False)
...
static int __pyx_f_9pycalphad_4core_10hyperplane_argmin(double *__pyx_v_a, int __pyx_v_a_shape, double *__pyx_v_lowest) {
  int __pyx_v_i;
  int __pyx_v_result;
  int __pyx_r;
  int __pyx_t_1;
  ...
  /* "pycalphad/core/hyperplane.pyx":40
 * cdef int argmin(double* a, int a_shape, double* lowest) nogil:
 *     cdef int i
 *     cdef int result = 0             # <<<<<<<<<<<<<<
 *     for i in range(a_shape):
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":41
 *     cdef int i
 *     cdef int result = 0
 *     for i in range(a_shape):             # <<<<<<<<<<<<<<
 *         if a[i] < lowest[0]:
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":42
 *     cdef int result = 0
 *     for i in range(a_shape):
 *         if a[i] < lowest[0]:             # <<<<<<<<<<<<<<
 *             lowest[0] = a[i]
 *             result = i
 */
    __pyx_t_4 = (((__pyx_v_a[__pyx_v_i]) < (__pyx_v_lowest[0])) != 0);
    if (__pyx_t_4) {

      /* "pycalphad/core/hyperplane.pyx":43
 *     for i in range(a_shape):
 *         if a[i] < lowest[0]:
 *             lowest[0] = a[i]             # <<<<<<<<<<<<<<
 *             result = i
 *     return result
 */
      (__pyx_v_lowest[0]) = (__pyx_v_a[__pyx_v_i]);

      /* "pycalphad/core/hyperplane.pyx":44
 *         if a[i] < lowest[0]:
 *             lowest[0] = a[i]
 *             result = i             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":45
 *             lowest[0] = a[i]
 *             result = i
 *     return result             # <<<<<<<<<<<<<<
 * 
...
/* "pycalphad/core/hyperplane.pyx":49
 * 
 * @cython.boundscheck(False)
...
static int __pyx_f_9pycalphad_4core_10hyperplane_argmax(double *__pyx_v_a, int __pyx_v_a_shape) {
  int __pyx_v_i;
  int __pyx_v_result;
  ...
  /* "pycalphad/core/hyperplane.pyx":51
 * cdef int argmax(double* a, int a_shape) nogil:
 *     cdef int i
 *     cdef int result = 0             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":52
 *     cdef int i
 *     cdef int result = 0
 *     cdef double highest = -1e30             # <<<<<<<<<<<<<<
 *     for i in range(a_shape):
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":53
 *     cdef int result = 0
 *     cdef double highest = -1e30
 *     for i in range(a_shape):             # <<<<<<<<<<<<<<
 *         if a[i] > highest:
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":54
 *     cdef double highest = -1e30
 *     for i in range(a_shape):
 *         if a[i] > highest:             # <<<<<<<<<<<<<<
 *             highest = a[i]
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "pycalphad/core/hyperplane.pyx":55
 *     for i in range(a_shape):
 *         if a[i] > highest:
 *             highest = a[i]             # <<<<<<<<<<<<<<
 *             result = i
 ...
 */
      ...
      /* "pycalphad/core/hyperplane.pyx":56
 *         if a[i] > highest:
 *             highest = a[i]
 *             result = i             # <<<<<<<<<<<<<<
 *     return result
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":57
 *             highest = a[i]
 *             result = i
 *     return result             # <<<<<<<<<<<<<<
 * 
...
/* "pycalphad/core/hyperplane.pyx":60
 * 
 * @cython.boundscheck(False)
...
static PyObject *__pyx_pw_9pycalphad_4core_10hyperplane_1hyperplane(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static double __pyx_f_9pycalphad_4core_10hyperplane_hyperplane(__Pyx_memviewslice __pyx_v_compositions, __Pyx_memviewslice __pyx_v_energies, __Pyx_memviewslice __pyx_v_composition, __Pyx_memviewslice __pyx_v_chemical_potentials, double __pyx_v_total_moles, __Pyx_memviewslice __pyx_v_fixed_chempot_indices, __Pyx_memviewslice __pyx_v_fixed_comp_indices, __Pyx_memviewslice __pyx_v_result_fractions, __Pyx_memviewslice __pyx_v_result_simplex, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_num_points;
  int __pyx_v_num_components;
  int __pyx_v_num_fixed_chempots;
  int __pyx_v_simplex_size;
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_fixed_index;
  int __pyx_v_saved_trial;
  int __pyx_v_min_df;
  ...
  int __pyx_v_simplex_idx;
  int __pyx_v_trial_idx;
  int __pyx_v_chempot_idx;
  int __pyx_v_skip_index;
  double __pyx_v_lowest_df;
  double __pyx_v_out_energy;
  int *__pyx_v_remaining_point_indices;
  int *__pyx_v_included_composition_indices;
  int *__pyx_v_best_guess_simplex;
  int *__pyx_v_free_chempot_indices;
  int *__pyx_v_candidate_simplex;
  int *__pyx_v_int_tmp;
  double *__pyx_v_candidate_potentials;
  double *__pyx_v_smallest_fractions;
  double *__pyx_v_driving_forces;
  int *__pyx_v_trial_simplices;
  double *__pyx_v_fractions;
  double *__pyx_v_f_contig_trial;
  double *__pyx_v_f_candidate_tieline;
  double *__pyx_v_f_trial_matrix;
  double __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
  int __pyx_t_3;
  ...
  /* "pycalphad/core/hyperplane.pyx":117
 *     """
 *     # Scalars
 ...
 */
  __pyx_v_num_points = (__pyx_v_compositions.shape[0]);

  /* "pycalphad/core/hyperplane.pyx":118
 *     # Scalars
 *     cdef int num_points = compositions.shape[0]
 *     cdef int num_components = compositions.shape[1]             # <<<<<<<<<<<<<<
 *     cdef int num_fixed_chempots = fixed_chempot_indices.shape[0]
 ...
 */
  __pyx_v_num_components = (__pyx_v_compositions.shape[1]);

  /* "pycalphad/core/hyperplane.pyx":119
 *     cdef int num_points = compositions.shape[0]
 *     cdef int num_components = compositions.shape[1]
 *     cdef int num_fixed_chempots = fixed_chempot_indices.shape[0]             # <<<<<<<<<<<<<<
 *     cdef int simplex_size = num_components - num_fixed_chempots
 *     cdef int i, j
 */
  __pyx_v_num_fixed_chempots = (__pyx_v_fixed_chempot_indices.shape[0]);

  /* "pycalphad/core/hyperplane.pyx":120
 *     cdef int num_components = compositions.shape[1]
 *     cdef int num_fixed_chempots = fixed_chempot_indices.shape[0]
 *     cdef int simplex_size = num_components - num_fixed_chempots             # <<<<<<<<<<<<<<
 *     cdef int i, j
 ...
 */
  __pyx_v_simplex_size = (__pyx_v_num_components - __pyx_v_num_fixed_chempots);

  /* "pycalphad/core/hyperplane.pyx":122
 *     cdef int simplex_size = num_components - num_fixed_chempots
 *     cdef int i, j
 *     cdef int fixed_index = 0             # <<<<<<<<<<<<<<
 ...
 *     cdef int min_df
 */
  __pyx_v_fixed_index = 0;

  /* "pycalphad/core/hyperplane.pyx":123
 *     cdef int i, j
 *     cdef int fixed_index = 0
 *     cdef int saved_trial = 0             # <<<<<<<<<<<<<<
 *     cdef int min_df
 ...
 */
  __pyx_v_saved_trial = 0;

  /* "pycalphad/core/hyperplane.pyx":125
 *     cdef int saved_trial = 0
 *     cdef int min_df
 *     cdef int max_iterations = 1000             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_max_iterations = 0x3E8;

  /* "pycalphad/core/hyperplane.pyx":126
 *     cdef int min_df
 *     cdef int max_iterations = 1000
 *     cdef int iterations = 0             # <<<<<<<<<<<<<<
 *     cdef int idx, ici, comp_idx, simplex_idx, trial_idx, chempot_idx
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":129
 *     cdef int idx, ici, comp_idx, simplex_idx, trial_idx, chempot_idx
 *     cdef bint tmp3
 ...
 */
  __pyx_v_skip_index = 0;

  /* "pycalphad/core/hyperplane.pyx":130
 *     cdef bint tmp3
 *     cdef bint skip_index = False
 *     cdef double lowest_df = 0             # <<<<<<<<<<<<<<
 *     cdef double out_energy = 0
 *     # 1-D
 */
  __pyx_v_lowest_df = 0.0;

  /* "pycalphad/core/hyperplane.pyx":131
 *     cdef bint skip_index = False
 *     cdef double lowest_df = 0
 *     cdef double out_energy = 0             # <<<<<<<<<<<<<<
 *     # 1-D
 ...
 */
  __pyx_v_out_energy = 0.0;

  /* "pycalphad/core/hyperplane.pyx":133
 *     cdef double out_energy = 0
 *     # 1-D
 *     cdef int* remaining_point_indices = <int*>malloc(num_points * sizeof(int))             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_remaining_point_indices = ((int *)malloc((__pyx_v_num_points * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":134
 *     # 1-D
 *     cdef int* remaining_point_indices = <int*>malloc(num_points * sizeof(int))
 *     for i in range(num_points):             # <<<<<<<<<<<<<<
 *         remaining_point_indices[i] = i
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":135
 *     cdef int* remaining_point_indices = <int*>malloc(num_points * sizeof(int))
 *     for i in range(num_points):
 *         remaining_point_indices[i] = i             # <<<<<<<<<<<<<<
 *     # composition index of -1 indicates total number of moles, i.e., N=1 condition
 ...
 */
    (__pyx_v_remaining_point_indices[__pyx_v_i]) = __pyx_v_i;
  }

  /* "pycalphad/core/hyperplane.pyx":137
 *         remaining_point_indices[i] = i
 *     # composition index of -1 indicates total number of moles, i.e., N=1 condition
 *     cdef int* included_composition_indices = <int*>malloc((fixed_comp_indices.shape[0] + 1) * sizeof(int))             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_included_composition_indices = ((int *)malloc((((__pyx_v_fixed_comp_indices.shape[0]) + 1) * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":138
 *     # composition index of -1 indicates total number of moles, i.e., N=1 condition
 *     cdef int* included_composition_indices = <int*>malloc((fixed_comp_indices.shape[0] + 1) * sizeof(int))
 *     for i in range(fixed_comp_indices.shape[0]):             # <<<<<<<<<<<<<<
 *         included_composition_indices[i] = fixed_comp_indices[i]
 ...
 */
  __pyx_t_4 = (__pyx_v_fixed_comp_indices.shape[0]);
  __pyx_t_5 = __pyx_t_4;
  for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_5; __pyx_t_1+=1) {
    __pyx_v_i = __pyx_t_1;

    /* "pycalphad/core/hyperplane.pyx":139
 *     cdef int* included_composition_indices = <int*>malloc((fixed_comp_indices.shape[0] + 1) * sizeof(int))
 *     for i in range(fixed_comp_indices.shape[0]):
 *         included_composition_indices[i] = fixed_comp_indices[i]             # <<<<<<<<<<<<<<
 *     included_composition_indices[fixed_comp_indices.shape[0]] = -1
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_fixed_comp_indices.shape[0];
    (__pyx_v_included_composition_indices[__pyx_v_i]) = (*((size_t *) ( /* dim=0 */ ((char *) (((size_t *) __pyx_v_fixed_comp_indices.data) + __pyx_t_6)) )));
  }

  /* "pycalphad/core/hyperplane.pyx":140
 *     for i in range(fixed_comp_indices.shape[0]):
 *         included_composition_indices[i] = fixed_comp_indices[i]
 *     included_composition_indices[fixed_comp_indices.shape[0]] = -1             # <<<<<<<<<<<<<<
 *     cdef int* best_guess_simplex = <int*>malloc(simplex_size * sizeof(int))
 ...
 */
  (__pyx_v_included_composition_indices[(__pyx_v_fixed_comp_indices.shape[0])]) = -1;

  /* "pycalphad/core/hyperplane.pyx":141
 *         included_composition_indices[i] = fixed_comp_indices[i]
 *     included_composition_indices[fixed_comp_indices.shape[0]] = -1
 *     cdef int* best_guess_simplex = <int*>malloc(simplex_size * sizeof(int))             # <<<<<<<<<<<<<<
 *     for i in range(num_components):
 *         skip_index = False
 */
  __pyx_v_best_guess_simplex = ((int *)malloc((__pyx_v_simplex_size * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":142
 *     included_composition_indices[fixed_comp_indices.shape[0]] = -1
 *     cdef int* best_guess_simplex = <int*>malloc(simplex_size * sizeof(int))
 *     for i in range(num_components):             # <<<<<<<<<<<<<<
 *         skip_index = False
 ...
 */
  __pyx_t_1 = __pyx_v_num_components;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pycalphad/core/hyperplane.pyx":143
 *     cdef int* best_guess_simplex = <int*>malloc(simplex_size * sizeof(int))
 *     for i in range(num_components):
 *         skip_index = False             # <<<<<<<<<<<<<<
 *         for j in range(num_fixed_chempots):
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":144
 *     for i in range(num_components):
 *         skip_index = False
 *         for j in range(num_fixed_chempots):             # <<<<<<<<<<<<<<
 *             if i == fixed_chempot_indices[j]:
 *                 skip_index = True
 */
    __pyx_t_7 = __pyx_v_num_fixed_chempots;
    __pyx_t_8 = __pyx_t_7;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_j = __pyx_t_9;

      /* "pycalphad/core/hyperplane.pyx":145
 *         skip_index = False
 *         for j in range(num_fixed_chempots):
 *             if i == fixed_chempot_indices[j]:             # <<<<<<<<<<<<<<
 *                 skip_index = True
 ...
 */
      __pyx_t_6 = __pyx_v_j;
      if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_fixed_chempot_indices.shape[0];
      __pyx_t_10 = ((__pyx_v_i == (*((size_t *) ( /* dim=0 */ ((char *) (((size_t *) __pyx_v_fixed_chempot_indices.data) + __pyx_t_6)) )))) != 0);
      if (__pyx_t_10) {

        /* "pycalphad/core/hyperplane.pyx":146
 *         for j in range(num_fixed_chempots):
 *             if i == fixed_chempot_indices[j]:
 *                 skip_index = True             # <<<<<<<<<<<<<<
 *         if skip_index:
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":147
 *             if i == fixed_chempot_indices[j]:
 *                 skip_index = True
 *         if skip_index:             # <<<<<<<<<<<<<<
 *             pass
 *         else:
 */
    __pyx_t_10 = (__pyx_v_skip_index != 0);
    if (__pyx_t_10) {
      goto __pyx_L12;
    }

    /* "pycalphad/core/hyperplane.pyx":150
 *             pass
 *         else:
 ...
 */
    /*else*/ {
      (__pyx_v_best_guess_simplex[__pyx_v_fixed_index]) = __pyx_v_i;

      /* "pycalphad/core/hyperplane.pyx":151
 *         else:
 *             best_guess_simplex[fixed_index] = i
 *             fixed_index += 1             # <<<<<<<<<<<<<<
 *     cdef int* free_chempot_indices = <int*>malloc(simplex_size * sizeof(int))
 ...
 */
      __pyx_v_fixed_index = (__pyx_v_fixed_index + 1);
    }
    __pyx_L12:;
  }

  /* "pycalphad/core/hyperplane.pyx":152
 *             best_guess_simplex[fixed_index] = i
 *             fixed_index += 1
 *     cdef int* free_chempot_indices = <int*>malloc(simplex_size * sizeof(int))             # <<<<<<<<<<<<<<
 *     cdef int* candidate_simplex = <int*>malloc(simplex_size * sizeof(int))
 ...
 */
  __pyx_v_free_chempot_indices = ((int *)malloc((__pyx_v_simplex_size * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":153
 *             fixed_index += 1
 *     cdef int* free_chempot_indices = <int*>malloc(simplex_size * sizeof(int))
 *     cdef int* candidate_simplex = <int*>malloc(simplex_size * sizeof(int))             # <<<<<<<<<<<<<<
 *     for i in range(simplex_size):
 ...
 */
  __pyx_v_candidate_simplex = ((int *)malloc((__pyx_v_simplex_size * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":154
 *     cdef int* free_chempot_indices = <int*>malloc(simplex_size * sizeof(int))
 *     cdef int* candidate_simplex = <int*>malloc(simplex_size * sizeof(int))
 *     for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *         free_chempot_indices[i] = best_guess_simplex[i]
 ...
 */
  __pyx_t_1 = __pyx_v_simplex_size;
  __pyx_t_2 = __pyx_t_1;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "pycalphad/core/hyperplane.pyx":155
 *     cdef int* candidate_simplex = <int*>malloc(simplex_size * sizeof(int))
 *     for i in range(simplex_size):
 *         free_chempot_indices[i] = best_guess_simplex[i]             # <<<<<<<<<<<<<<
 *         candidate_simplex[i] = best_guess_simplex[i]
 ...
 */
    (__pyx_v_free_chempot_indices[__pyx_v_i]) = (__pyx_v_best_guess_simplex[__pyx_v_i]);

    /* "pycalphad/core/hyperplane.pyx":156
 *     for i in range(simplex_size):
 *         free_chempot_indices[i] = best_guess_simplex[i]
 *         candidate_simplex[i] = best_guess_simplex[i]             # <<<<<<<<<<<<<<
 *     cdef int* int_tmp = <int*>malloc(simplex_size * sizeof(int)) # np.empty(simplex_size, dtype=np.int32)
 ...
 */
    (__pyx_v_candidate_simplex[__pyx_v_i]) = (__pyx_v_best_guess_simplex[__pyx_v_i]);
  }

  /* "pycalphad/core/hyperplane.pyx":157
 *         free_chempot_indices[i] = best_guess_simplex[i]
 *         candidate_simplex[i] = best_guess_simplex[i]
 *     cdef int* int_tmp = <int*>malloc(simplex_size * sizeof(int)) # np.empty(simplex_size, dtype=np.int32)             # <<<<<<<<<<<<<<
 *     cdef double* candidate_potentials = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)
 ...
 */
  __pyx_v_int_tmp = ((int *)malloc((__pyx_v_simplex_size * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":158
 *         candidate_simplex[i] = best_guess_simplex[i]
 *     cdef int* int_tmp = <int*>malloc(simplex_size * sizeof(int)) # np.empty(simplex_size, dtype=np.int32)
 *     cdef double* candidate_potentials = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)             # <<<<<<<<<<<<<<
 *     cdef double* smallest_fractions = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)
 ...
 */
  __pyx_v_candidate_potentials = ((double *)malloc((__pyx_v_simplex_size * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":159
 *     cdef int* int_tmp = <int*>malloc(simplex_size * sizeof(int)) # np.empty(simplex_size, dtype=np.int32)
 *     cdef double* candidate_potentials = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)
 *     cdef double* smallest_fractions = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)             # <<<<<<<<<<<<<<
 *     cdef double* driving_forces = <double*>malloc(num_points * sizeof(double)) # np.empty(compositions.shape[0])
 *     # 2-D
 */
  __pyx_v_smallest_fractions = ((double *)malloc((__pyx_v_simplex_size * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":160
 *     cdef double* candidate_potentials = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)
 *     cdef double* smallest_fractions = <double*>malloc(simplex_size * sizeof(double)) # np.empty(simplex_size)
 *     cdef double* driving_forces = <double*>malloc(num_points * sizeof(double)) # np.empty(compositions.shape[0])             # <<<<<<<<<<<<<<
 *     # 2-D
 ...
 */
  __pyx_v_driving_forces = ((double *)malloc((__pyx_v_num_points * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":162
 *     cdef double* driving_forces = <double*>malloc(num_points * sizeof(double)) # np.empty(compositions.shape[0])
 *     # 2-D
 *     cdef int* trial_simplices = <int*>malloc(simplex_size * simplex_size * sizeof(int)) # np.empty((simplex_size, simplex_size), dtype=np.int32)             # <<<<<<<<<<<<<<
 ...
 *     for i in range(simplex_size):
 */
  __pyx_v_trial_simplices = ((int *)malloc(((__pyx_v_simplex_size * __pyx_v_simplex_size) * (sizeof(int)))));

  /* "pycalphad/core/hyperplane.pyx":163
 *     # 2-D
 *     cdef int* trial_simplices = <int*>malloc(simplex_size * simplex_size * sizeof(int)) # np.empty((simplex_size, simplex_size), dtype=np.int32)
 *     cdef double* fractions = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size))             # <<<<<<<<<<<<<<
 *     for i in range(simplex_size):
 ...
 */
  __pyx_v_fractions = ((double *)malloc(((__pyx_v_simplex_size * __pyx_v_simplex_size) * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":164
 *     cdef int* trial_simplices = <int*>malloc(simplex_size * simplex_size * sizeof(int)) # np.empty((simplex_size, simplex_size), dtype=np.int32)
 *     cdef double* fractions = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size))
 *     for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *         for j in range(simplex_size):
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":165
 *     cdef double* fractions = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size))
 *     for i in range(simplex_size):
 *         for j in range(simplex_size):             # <<<<<<<<<<<<<<
 *             trial_simplices[i*simplex_size + j] = best_guess_simplex[j]
 ...
 */
    __pyx_t_7 = __pyx_v_simplex_size;
    __pyx_t_8 = __pyx_t_7;
    for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
      __pyx_v_j = __pyx_t_9;

      /* "pycalphad/core/hyperplane.pyx":166
 *     for i in range(simplex_size):
 *         for j in range(simplex_size):
 *             trial_simplices[i*simplex_size + j] = best_guess_simplex[j]             # <<<<<<<<<<<<<<
 *     cdef double* f_contig_trial = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')
 ...
 */
      (__pyx_v_trial_simplices[((__pyx_v_i * __pyx_v_simplex_size) + __pyx_v_j)]) = (__pyx_v_best_guess_simplex[__pyx_v_j]);
    }
  }

  /* "pycalphad/core/hyperplane.pyx":167
 *         for j in range(simplex_size):
 *             trial_simplices[i*simplex_size + j] = best_guess_simplex[j]
 *     cdef double* f_contig_trial = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')             # <<<<<<<<<<<<<<
 *     cdef double* f_candidate_tieline = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')
 *     # 3-D
 */
  __pyx_v_f_contig_trial = ((double *)malloc(((__pyx_v_simplex_size * __pyx_v_simplex_size) * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":168
 *             trial_simplices[i*simplex_size + j] = best_guess_simplex[j]
 *     cdef double* f_contig_trial = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')
 *     cdef double* f_candidate_tieline = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')             # <<<<<<<<<<<<<<
 *     # 3-D
 ...
 */
  __pyx_v_f_candidate_tieline = ((double *)malloc(((__pyx_v_simplex_size * __pyx_v_simplex_size) * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":170
 *     cdef double* f_candidate_tieline = <double*>malloc(simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size), order='F')
 *     # 3-D
 *     cdef double* f_trial_matrix = <double*>malloc(simplex_size * simplex_size * simplex_size * sizeof(double)) # np.empty((simplex_size, simplex_size, simplex_size), order='F')             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_v_f_trial_matrix = ((double *)malloc((((__pyx_v_simplex_size * __pyx_v_simplex_size) * __pyx_v_simplex_size) * (sizeof(double)))));

  /* "pycalphad/core/hyperplane.pyx":173
 * 
 * 
 ...
 */
  while (1) {
    __pyx_t_10 = ((__pyx_v_iterations < __pyx_v_max_iterations) != 0);
    if (!__pyx_t_10) break;

    /* "pycalphad/core/hyperplane.pyx":174
 * 
 *     while iterations < max_iterations:
 *         iterations += 1             # <<<<<<<<<<<<<<
 *         for trial_idx in range(simplex_size):
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":175
 *     while iterations < max_iterations:
 *         iterations += 1
 *         for trial_idx in range(simplex_size):             # <<<<<<<<<<<<<<
 *             #smallest_fractions[trial_idx] = 0
 ...
 */
    ...
    __pyx_t_2 = __pyx_t_1;
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      __pyx_v_trial_idx = __pyx_t_3;

      /* "pycalphad/core/hyperplane.pyx":177
 *         for trial_idx in range(simplex_size):
 *             #smallest_fractions[trial_idx] = 0
 *             for comp_idx in range(simplex_size):             # <<<<<<<<<<<<<<
 ...
 */
      ...
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_comp_idx = __pyx_t_9;

        /* "pycalphad/core/hyperplane.pyx":178
 *             #smallest_fractions[trial_idx] = 0
 *             for comp_idx in range(simplex_size):
 *                 ici = included_composition_indices[comp_idx]             # <<<<<<<<<<<<<<
 *                 for simplex_idx in range(simplex_size):
 *                     if ici >= 0:
 */
        __pyx_v_ici = (__pyx_v_included_composition_indices[__pyx_v_comp_idx]);

        /* "pycalphad/core/hyperplane.pyx":179
 *             for comp_idx in range(simplex_size):
 *                 ici = included_composition_indices[comp_idx]
 *                 for simplex_idx in range(simplex_size):             # <<<<<<<<<<<<<<
 *                     if ici >= 0:
 ...
 */
        __pyx_t_11 = __pyx_v_simplex_size;
        __pyx_t_12 = __pyx_t_11;
        for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
          __pyx_v_simplex_idx = __pyx_t_13;

          /* "pycalphad/core/hyperplane.pyx":180
 *                 ici = included_composition_indices[comp_idx]
 *                 for simplex_idx in range(simplex_size):
 *                     if ici >= 0:             # <<<<<<<<<<<<<<
 *                         f_trial_matrix[comp_idx + simplex_idx*simplex_size + trial_idx*simplex_size*simplex_size] = \
 ...
 */
          __pyx_t_10 = ((__pyx_v_ici >= 0) != 0);
          if (__pyx_t_10) {

            /* "pycalphad/core/hyperplane.pyx":182
 *                     if ici >= 0:
 *                         f_trial_matrix[comp_idx + simplex_idx*simplex_size + trial_idx*simplex_size*simplex_size] = \
 *                             compositions[trial_simplices[trial_idx*simplex_size + simplex_idx], ici]             # <<<<<<<<<<<<<<
 *                     else:
 ...
 */
            __pyx_t_6 = (__pyx_v_trial_simplices[((__pyx_v_trial_idx * __pyx_v_simplex_size) + __pyx_v_simplex_idx)]);
            __pyx_t_14 = __pyx_v_ici;
            if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_compositions.shape[0];
            if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_compositions.shape[1];

            /* "pycalphad/core/hyperplane.pyx":181
 *                 for simplex_idx in range(simplex_size):
 *                     if ici >= 0:
 *                         f_trial_matrix[comp_idx + simplex_idx*simplex_size + trial_idx*simplex_size*simplex_size] = \             # <<<<<<<<<<<<<<
 *                             compositions[trial_simplices[trial_idx*simplex_size + simplex_idx], ici]
 *                     else:
 */
            (__pyx_v_f_trial_matrix[((__pyx_v_comp_idx + (__pyx_v_simplex_idx * __pyx_v_simplex_size)) + ((__pyx_v_trial_idx * __pyx_v_simplex_size) * __pyx_v_simplex_size))]) = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_compositions.data + __pyx_t_6 * __pyx_v_compositions.strides[0]) )) + __pyx_t_14)) )));
 ...
 */
          ...
          /* "pycalphad/core/hyperplane.pyx":185
 *                     else:
 *                         # ici = -1, refers to N=1 condition
 ...
 */
          /*else*/ {
            (__pyx_v_f_trial_matrix[((__pyx_v_comp_idx + (__pyx_v_simplex_idx * __pyx_v_simplex_size)) + ((__pyx_v_trial_idx * __pyx_v_simplex_size) * __pyx_v_simplex_size))]) = 1.0;
          }
          __pyx_L27:;
        }
      }
    ...
    /* "pycalphad/core/hyperplane.pyx":187
 *                         f_trial_matrix[comp_idx + simplex_idx*simplex_size + trial_idx*simplex_size*simplex_size] = 1 # 1 mole-formula per formula unit of a phase
 * 
 *         for trial_idx in range(simplex_size):             # <<<<<<<<<<<<<<
 *             for i in range(simplex_size):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":188
 * 
 *         for trial_idx in range(simplex_size):
 *             for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *                 for j in range(simplex_size):
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "pycalphad/core/hyperplane.pyx":189
 *         for trial_idx in range(simplex_size):
 *             for i in range(simplex_size):
 *                 for j in range(simplex_size):             # <<<<<<<<<<<<<<
 *                     f_contig_trial[i + j*simplex_size] = f_trial_matrix[i + j*simplex_size + trial_idx*simplex_size*simplex_size]
 ...
 */
        ...
        for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
          ...
          /* "pycalphad/core/hyperplane.pyx":190
 *             for i in range(simplex_size):
 *                 for j in range(simplex_size):
 *                     f_contig_trial[i + j*simplex_size] = f_trial_matrix[i + j*simplex_size + trial_idx*simplex_size*simplex_size]             # <<<<<<<<<<<<<<
 *             for simplex_idx in range(simplex_size):
 ...
 */
          (__pyx_v_f_contig_trial[(__pyx_v_i + (__pyx_v_j * __pyx_v_simplex_size))]) = (__pyx_v_f_trial_matrix[((__pyx_v_i + (__pyx_v_j * __pyx_v_simplex_size)) + ((__pyx_v_trial_idx * __pyx_v_simplex_size) * __pyx_v_simplex_size))]);
        }
      }

      /* "pycalphad/core/hyperplane.pyx":191
 *                 for j in range(simplex_size):
 *                     f_contig_trial[i + j*simplex_size] = f_trial_matrix[i + j*simplex_size + trial_idx*simplex_size*simplex_size]
 *             for simplex_idx in range(simplex_size):             # <<<<<<<<<<<<<<
 *                 ici = included_composition_indices[simplex_idx]
 ...
 */
      ...
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_simplex_idx = __pyx_t_9;

        /* "pycalphad/core/hyperplane.pyx":192
 *                     f_contig_trial[i + j*simplex_size] = f_trial_matrix[i + j*simplex_size + trial_idx*simplex_size*simplex_size]
 *             for simplex_idx in range(simplex_size):
 *                 ici = included_composition_indices[simplex_idx]             # <<<<<<<<<<<<<<
 *                 if ici >= 0:
 ...
 */
        __pyx_v_ici = (__pyx_v_included_composition_indices[__pyx_v_simplex_idx]);

        /* "pycalphad/core/hyperplane.pyx":193
 *             for simplex_idx in range(simplex_size):
 *                 ici = included_composition_indices[simplex_idx]
 *                 if ici >= 0:             # <<<<<<<<<<<<<<
 *                     fractions[trial_idx*simplex_size + simplex_idx] = composition[ici]
 ...
 */
        ...
        if (__pyx_t_10) {
          ...
          /* "pycalphad/core/hyperplane.pyx":194
 *                 ici = included_composition_indices[simplex_idx]
 *                 if ici >= 0:
 *                     fractions[trial_idx*simplex_size + simplex_idx] = composition[ici]             # <<<<<<<<<<<<<<
 *                 else:
 ...
 */
          __pyx_t_14 = __pyx_v_ici;
          if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_composition.shape[0];
          (__pyx_v_fractions[((__pyx_v_trial_idx * __pyx_v_simplex_size) + __pyx_v_simplex_idx)]) = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_composition.data) + __pyx_t_14)) )));
 ...
 */
        ...
        /* "pycalphad/core/hyperplane.pyx":197
 *                 else:
 *                     # ici = -1, refers to N=1 condition
 ...
 */
        /*else*/ {
          (__pyx_v_fractions[((__pyx_v_trial_idx * __pyx_v_simplex_size) + __pyx_v_simplex_idx)]) = __pyx_v_total_moles;
        }
        __pyx_L36:;
      }

      /* "pycalphad/core/hyperplane.pyx":198
 *                     # ici = -1, refers to N=1 condition
 *                     fractions[trial_idx*simplex_size + simplex_idx] = total_moles
 *             solve(f_contig_trial, simplex_size, &fractions[trial_idx*simplex_size], int_tmp)             # <<<<<<<<<<<<<<
 *             smallest_fractions[trial_idx] = _min(&fractions[trial_idx*simplex_size], simplex_size)
 * 
 */
      __pyx_f_9pycalphad_4core_10hyperplane_solve(__pyx_v_f_contig_trial, __pyx_v_simplex_size, (&(__pyx_v_fractions[(__pyx_v_trial_idx * __pyx_v_simplex_size)])), __pyx_v_int_tmp);

      /* "pycalphad/core/hyperplane.pyx":199
 *                     fractions[trial_idx*simplex_size + simplex_idx] = total_moles
 *             solve(f_contig_trial, simplex_size, &fractions[trial_idx*simplex_size], int_tmp)
 *             smallest_fractions[trial_idx] = _min(&fractions[trial_idx*simplex_size], simplex_size)             # <<<<<<<<<<<<<<
 * 
 ...
 */
      (__pyx_v_smallest_fractions[__pyx_v_trial_idx]) = __pyx_f_9pycalphad_4core_10hyperplane__min((&(__pyx_v_fractions[(__pyx_v_trial_idx * __pyx_v_simplex_size)])), __pyx_v_simplex_size);
    }

    /* "pycalphad/core/hyperplane.pyx":202
 * 
 *         # Choose simplex with the largest smallest-fraction
 ...
 *             break
 */
    __pyx_v_saved_trial = __pyx_f_9pycalphad_4core_10hyperplane_argmax(__pyx_v_smallest_fractions, __pyx_v_simplex_size);

    /* "pycalphad/core/hyperplane.pyx":203
 *         # Choose simplex with the largest smallest-fraction
 *         saved_trial = argmax(smallest_fractions, simplex_size)
 *         if smallest_fractions[saved_trial] < -simplex_size:             # <<<<<<<<<<<<<<
 *             break
 ...
 */
    __pyx_t_10 = (((__pyx_v_smallest_fractions[__pyx_v_saved_trial]) < (-__pyx_v_simplex_size)) != 0);
    if (__pyx_t_10) {

      /* "pycalphad/core/hyperplane.pyx":204
 *         saved_trial = argmax(smallest_fractions, simplex_size)
 *         if smallest_fractions[saved_trial] < -simplex_size:
 *             break             # <<<<<<<<<<<<<<
 *         # Should be exactly one candidate simplex
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":206
 *             break
 *         # Should be exactly one candidate simplex
 *         for i in range(simplex_size):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":207
 *         # Should be exactly one candidate simplex
 *         for i in range(simplex_size):
 *             candidate_simplex[i] = trial_simplices[saved_trial*simplex_size + i]             # <<<<<<<<<<<<<<
 *         for i in range(simplex_size):
 ...
 */
      (__pyx_v_candidate_simplex[__pyx_v_i]) = (__pyx_v_trial_simplices[((__pyx_v_saved_trial * __pyx_v_simplex_size) + __pyx_v_i)]);
    }

    /* "pycalphad/core/hyperplane.pyx":208
 *         for i in range(simplex_size):
 *             candidate_simplex[i] = trial_simplices[saved_trial*simplex_size + i]
 *         for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *             idx = candidate_simplex[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":209
 *             candidate_simplex[i] = trial_simplices[saved_trial*simplex_size + i]
 *         for i in range(simplex_size):
 *             idx = candidate_simplex[i]             # <<<<<<<<<<<<<<
 *             for ici in range(simplex_size):
 ...
 */
      __pyx_v_idx = (__pyx_v_candidate_simplex[__pyx_v_i]);

      /* "pycalphad/core/hyperplane.pyx":210
 *         for i in range(simplex_size):
 *             idx = candidate_simplex[i]
 *             for ici in range(simplex_size):             # <<<<<<<<<<<<<<
 *                 chempot_idx = free_chempot_indices[ici]
 ...
 */
      ...
      __pyx_t_8 = __pyx_t_7;
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        __pyx_v_ici = __pyx_t_9;

        /* "pycalphad/core/hyperplane.pyx":211
 *             idx = candidate_simplex[i]
 *             for ici in range(simplex_size):
 *                 chempot_idx = free_chempot_indices[ici]             # <<<<<<<<<<<<<<
 *                 f_candidate_tieline[i + simplex_size*ici] = compositions[idx, chempot_idx]
 ...
 */
        __pyx_v_chempot_idx = (__pyx_v_free_chempot_indices[__pyx_v_ici]);

        /* "pycalphad/core/hyperplane.pyx":212
 *             for ici in range(simplex_size):
 *                 chempot_idx = free_chempot_indices[ici]
 *                 f_candidate_tieline[i + simplex_size*ici] = compositions[idx, chempot_idx]             # <<<<<<<<<<<<<<
 *             candidate_potentials[i] = energies[idx]
 ...
 */
        ...
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_compositions.shape[0];
        if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_compositions.shape[1];
        (__pyx_v_f_candidate_tieline[(__pyx_v_i + (__pyx_v_simplex_size * __pyx_v_ici))]) = (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_compositions.data + __pyx_t_14 * __pyx_v_compositions.strides[0]) )) + __pyx_t_6)) )));
      }

      /* "pycalphad/core/hyperplane.pyx":213
 *                 chempot_idx = free_chempot_indices[ici]
 *                 f_candidate_tieline[i + simplex_size*ici] = compositions[idx, chempot_idx]
 *             candidate_potentials[i] = energies[idx]             # <<<<<<<<<<<<<<
 *             for ici in range(fixed_chempot_indices.shape[0]):
 ...
 */
      ...
      if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_energies.shape[0];
      (__pyx_v_candidate_potentials[__pyx_v_i]) = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_energies.data) + __pyx_t_6)) )));

      /* "pycalphad/core/hyperplane.pyx":214
 *                 f_candidate_tieline[i + simplex_size*ici] = compositions[idx, chempot_idx]
 *             candidate_potentials[i] = energies[idx]
 *             for ici in range(fixed_chempot_indices.shape[0]):             # <<<<<<<<<<<<<<
 *                 chempot_idx = fixed_chempot_indices[ici]
 ...
 */
      __pyx_t_4 = (__pyx_v_fixed_chempot_indices.shape[0]);
      __pyx_t_5 = __pyx_t_4;
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_5; __pyx_t_7+=1) {
        __pyx_v_ici = __pyx_t_7;

        /* "pycalphad/core/hyperplane.pyx":215
 *             candidate_potentials[i] = energies[idx]
 *             for ici in range(fixed_chempot_indices.shape[0]):
 *                 chempot_idx = fixed_chempot_indices[ici]             # <<<<<<<<<<<<<<
 *                 candidate_potentials[i] -= chemical_potentials[chempot_idx] * compositions[idx, chempot_idx]
 ...
 */
        __pyx_t_6 = __pyx_v_ici;
        if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_fixed_chempot_indices.shape[0];
        __pyx_v_chempot_idx = (*((size_t *) ( /* dim=0 */ ((char *) (((size_t *) __pyx_v_fixed_chempot_indices.data) + __pyx_t_6)) )));

        /* "pycalphad/core/hyperplane.pyx":216
 *             for ici in range(fixed_chempot_indices.shape[0]):
 *                 chempot_idx = fixed_chempot_indices[ici]
 *                 candidate_potentials[i] -= chemical_potentials[chempot_idx] * compositions[idx, chempot_idx]             # <<<<<<<<<<<<<<
 *         solve(f_candidate_tieline, simplex_size, candidate_potentials, int_tmp)
 ...
 */
        __pyx_t_8 = __pyx_v_i;
        __pyx_t_6 = __pyx_v_chempot_idx;
        if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_chemical_potentials.shape[0];
        __pyx_t_14 = __pyx_v_idx;
        __pyx_t_15 = __pyx_v_chempot_idx;
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_compositions.shape[0];
        if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_compositions.shape[1];
        (__pyx_v_candidate_potentials[__pyx_t_8]) = ((__pyx_v_candidate_potentials[__pyx_t_8]) - ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chemical_potentials.data) + __pyx_t_6)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_compositions.data + __pyx_t_14 * __pyx_v_compositions.strides[0]) )) + __pyx_t_15)) )))));
      }
    }

    /* "pycalphad/core/hyperplane.pyx":217
 *                 chempot_idx = fixed_chempot_indices[ici]
 *                 candidate_potentials[i] -= chemical_potentials[chempot_idx] * compositions[idx, chempot_idx]
 *         solve(f_candidate_tieline, simplex_size, candidate_potentials, int_tmp)             # <<<<<<<<<<<<<<
 *         if candidate_potentials[0] == -1e19:
 *             break
 */
    __pyx_f_9pycalphad_4core_10hyperplane_solve(__pyx_v_f_candidate_tieline, __pyx_v_simplex_size, __pyx_v_candidate_potentials, __pyx_v_int_tmp);

    /* "pycalphad/core/hyperplane.pyx":218
 *                 candidate_potentials[i] -= chemical_potentials[chempot_idx] * compositions[idx, chempot_idx]
 *         solve(f_candidate_tieline, simplex_size, candidate_potentials, int_tmp)
 *         if candidate_potentials[0] == -1e19:             # <<<<<<<<<<<<<<
 *             break
 *         for i in range(num_points):
 */
    __pyx_t_10 = (((__pyx_v_candidate_potentials[0]) == -1e19) != 0);
    if (__pyx_t_10) {

      /* "pycalphad/core/hyperplane.pyx":219
 *         solve(f_candidate_tieline, simplex_size, candidate_potentials, int_tmp)
 *         if candidate_potentials[0] == -1e19:
 *             break             # <<<<<<<<<<<<<<
 *         for i in range(num_points):
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":220
 *         if candidate_potentials[0] == -1e19:
 *             break
 *         for i in range(num_points):             # <<<<<<<<<<<<<<
 *             driving_forces[i] = energies[remaining_point_indices[i]]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":221
 *             break
 *         for i in range(num_points):
 *             driving_forces[i] = energies[remaining_point_indices[i]]             # <<<<<<<<<<<<<<
 *         for ici in range(simplex_size):
 *             chempot_idx = free_chempot_indices[ici]
 */
      __pyx_t_15 = (__pyx_v_remaining_point_indices[__pyx_v_i]);
      if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_energies.shape[0];
      (__pyx_v_driving_forces[__pyx_v_i]) = (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_energies.data) + __pyx_t_15)) )));
    }

    /* "pycalphad/core/hyperplane.pyx":222
 *         for i in range(num_points):
 *             driving_forces[i] = energies[remaining_point_indices[i]]
 *         for ici in range(simplex_size):             # <<<<<<<<<<<<<<
 *             chempot_idx = free_chempot_indices[ici]
 ...
 */
    ...
    __pyx_t_2 = __pyx_t_1;
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      __pyx_v_ici = __pyx_t_3;

      /* "pycalphad/core/hyperplane.pyx":223
 *             driving_forces[i] = energies[remaining_point_indices[i]]
 *         for ici in range(simplex_size):
 *             chempot_idx = free_chempot_indices[ici]             # <<<<<<<<<<<<<<
 *             for idx in range(num_points):
 ...
 */
      ...
      /* "pycalphad/core/hyperplane.pyx":224
 *         for ici in range(simplex_size):
 *             chempot_idx = free_chempot_indices[ici]
 *             for idx in range(num_points):             # <<<<<<<<<<<<<<
 *                 driving_forces[idx] -= candidate_potentials[ici] * compositions[remaining_point_indices[idx], chempot_idx]
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "pycalphad/core/hyperplane.pyx":225
 *             chempot_idx = free_chempot_indices[ici]
 *             for idx in range(num_points):
 *                 driving_forces[idx] -= candidate_potentials[ici] * compositions[remaining_point_indices[idx], chempot_idx]             # <<<<<<<<<<<<<<
 *         for ici in range(fixed_chempot_indices.shape[0]):
 ...
 */
        ...
        __pyx_t_15 = (__pyx_v_remaining_point_indices[__pyx_v_idx]);
        __pyx_t_14 = __pyx_v_chempot_idx;
        if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_compositions.shape[0];
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_compositions.shape[1];
        (__pyx_v_driving_forces[__pyx_t_11]) = ((__pyx_v_driving_forces[__pyx_t_11]) - ((__pyx_v_candidate_potentials[__pyx_v_ici]) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_compositions.data + __pyx_t_15 * __pyx_v_compositions.strides[0]) )) + __pyx_t_14)) )))));
      }
    }

    /* "pycalphad/core/hyperplane.pyx":226
 *             for idx in range(num_points):
 *                 driving_forces[idx] -= candidate_potentials[ici] * compositions[remaining_point_indices[idx], chempot_idx]
 *         for ici in range(fixed_chempot_indices.shape[0]):             # <<<<<<<<<<<<<<
 *             chempot_idx = fixed_chempot_indices[ici]
 ...
 */
    ...
    __pyx_t_5 = __pyx_t_4;
    for (__pyx_t_1 = 0; __pyx_t_1 < __pyx_t_5; __pyx_t_1+=1) {
      __pyx_v_ici = __pyx_t_1;

      /* "pycalphad/core/hyperplane.pyx":227
 *                 driving_forces[idx] -= candidate_potentials[ici] * compositions[remaining_point_indices[idx], chempot_idx]
 *         for ici in range(fixed_chempot_indices.shape[0]):
 *             chempot_idx = fixed_chempot_indices[ici]             # <<<<<<<<<<<<<<
 *             for idx in range(num_points):
 ...
 */
      __pyx_t_14 = __pyx_v_ici;
      if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_fixed_chempot_indices.shape[0];
      __pyx_v_chempot_idx = (*((size_t *) ( /* dim=0 */ ((char *) (((size_t *) __pyx_v_fixed_chempot_indices.data) + __pyx_t_14)) )));

      /* "pycalphad/core/hyperplane.pyx":228
 *         for ici in range(fixed_chempot_indices.shape[0]):
 *             chempot_idx = fixed_chempot_indices[ici]
 *             for idx in range(num_points):             # <<<<<<<<<<<<<<
 *                 driving_forces[idx] -= chemical_potentials[chempot_idx] * compositions[remaining_point_indices[idx], chempot_idx]
 ...
 */
      ...
      for (__pyx_t_7 = 0; __pyx_t_7 < __pyx_t_3; __pyx_t_7+=1) {
        ...
        /* "pycalphad/core/hyperplane.pyx":229
 *             chempot_idx = fixed_chempot_indices[ici]
 *             for idx in range(num_points):
 *                 driving_forces[idx] -= chemical_potentials[chempot_idx] * compositions[remaining_point_indices[idx], chempot_idx]             # <<<<<<<<<<<<<<
 *         for i in range(simplex_size):
 ...
 */
        ...
        __pyx_t_14 = __pyx_v_chempot_idx;
        if (__pyx_t_14 < 0) __pyx_t_14 += __pyx_v_chemical_potentials.shape[0];
        __pyx_t_15 = (__pyx_v_remaining_point_indices[__pyx_v_idx]);
        __pyx_t_6 = __pyx_v_chempot_idx;
        if (__pyx_t_15 < 0) __pyx_t_15 += __pyx_v_compositions.shape[0];
        if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_compositions.shape[1];
        (__pyx_v_driving_forces[__pyx_t_8]) = ((__pyx_v_driving_forces[__pyx_t_8]) - ((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chemical_potentials.data) + __pyx_t_14)) ))) * (*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_compositions.data + __pyx_t_15 * __pyx_v_compositions.strides[0]) )) + __pyx_t_6)) )))));
      }
    }

    /* "pycalphad/core/hyperplane.pyx":230
 *             for idx in range(num_points):
 *                 driving_forces[idx] -= chemical_potentials[chempot_idx] * compositions[remaining_point_indices[idx], chempot_idx]
 *         for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *             best_guess_simplex[i] = candidate_simplex[i]
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":231
 *                 driving_forces[idx] -= chemical_potentials[chempot_idx] * compositions[remaining_point_indices[idx], chempot_idx]
 *         for i in range(simplex_size):
 *             best_guess_simplex[i] = candidate_simplex[i]             # <<<<<<<<<<<<<<
 *         for i in range(simplex_size):
 *             for j in range(simplex_size):
 */
      (__pyx_v_best_guess_simplex[__pyx_v_i]) = (__pyx_v_candidate_simplex[__pyx_v_i]);
    }

    /* "pycalphad/core/hyperplane.pyx":232
 *         for i in range(simplex_size):
 *             best_guess_simplex[i] = candidate_simplex[i]
 *         for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *             for j in range(simplex_size):
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":233
 *             best_guess_simplex[i] = candidate_simplex[i]
 *         for i in range(simplex_size):
 *             for j in range(simplex_size):             # <<<<<<<<<<<<<<
 *                 trial_simplices[i*simplex_size + j] = best_guess_simplex[j]
 ...
 */
      ...
      for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
        ...
        /* "pycalphad/core/hyperplane.pyx":234
 *         for i in range(simplex_size):
 *             for j in range(simplex_size):
 *                 trial_simplices[i*simplex_size + j] = best_guess_simplex[j]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":237
 * 
 *         # Only points below, or at, the candidate hyperplane can possibly be part of the solution
 *         ici = 0             # <<<<<<<<<<<<<<
 *         lowest_df = 1e10
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":238
 *         # Only points below, or at, the candidate hyperplane can possibly be part of the solution
 *         ici = 0
 *         lowest_df = 1e10             # <<<<<<<<<<<<<<
 *         min_df = -1
 *         for i in range(num_points):
 */
    __pyx_v_lowest_df = 1e10;

    /* "pycalphad/core/hyperplane.pyx":239
 *         ici = 0
 *         lowest_df = 1e10
 *         min_df = -1             # <<<<<<<<<<<<<<
 *         for i in range(num_points):
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":240
 *         lowest_df = 1e10
 *         min_df = -1
 *         for i in range(num_points):             # <<<<<<<<<<<<<<
 *             if driving_forces[i] < 1.0:
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":241
 *         min_df = -1
 *         for i in range(num_points):
 *             if driving_forces[i] < 1.0:             # <<<<<<<<<<<<<<
 *                 remaining_point_indices[ici] = remaining_point_indices[i]
 ...
 */
      __pyx_t_10 = (((__pyx_v_driving_forces[__pyx_v_i]) < 1.0) != 0);
      if (__pyx_t_10) {

        /* "pycalphad/core/hyperplane.pyx":242
 *         for i in range(num_points):
 *             if driving_forces[i] < 1.0:
 *                 remaining_point_indices[ici] = remaining_point_indices[i]             # <<<<<<<<<<<<<<
 *                 if driving_forces[i] < lowest_df:
 ...
 */
        (__pyx_v_remaining_point_indices[__pyx_v_ici]) = (__pyx_v_remaining_point_indices[__pyx_v_i]);

        /* "pycalphad/core/hyperplane.pyx":243
 *             if driving_forces[i] < 1.0:
 *                 remaining_point_indices[ici] = remaining_point_indices[i]
 *                 if driving_forces[i] < lowest_df:             # <<<<<<<<<<<<<<
 *                     lowest_df = driving_forces[i]
 *                     min_df = ici
 */
        __pyx_t_10 = (((__pyx_v_driving_forces[__pyx_v_i]) < __pyx_v_lowest_df) != 0);
        if (__pyx_t_10) {

          /* "pycalphad/core/hyperplane.pyx":244
 *                 remaining_point_indices[ici] = remaining_point_indices[i]
 *                 if driving_forces[i] < lowest_df:
 *                     lowest_df = driving_forces[i]             # <<<<<<<<<<<<<<
 *                     min_df = ici
 *                 ici += 1
 */
          __pyx_v_lowest_df = (__pyx_v_driving_forces[__pyx_v_i]);

          /* "pycalphad/core/hyperplane.pyx":245
 *                 if driving_forces[i] < lowest_df:
 *                     lowest_df = driving_forces[i]
 *                     min_df = ici             # <<<<<<<<<<<<<<
 *                 ici += 1
 ...
 */
        ...
        /* "pycalphad/core/hyperplane.pyx":246
 *                     lowest_df = driving_forces[i]
 *                     min_df = ici
 *                 ici += 1             # <<<<<<<<<<<<<<
 *         num_points = ici
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":247
 *                     min_df = ici
 *                 ici += 1
 *         num_points = ici             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_num_points = __pyx_v_ici;

    /* "pycalphad/core/hyperplane.pyx":253
 ...
 */
    ...
    for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
      ...
      /* "pycalphad/core/hyperplane.pyx":254
 *         #     excepting edge cases
 *         for i in range(simplex_size):
 *             trial_simplices[i*simplex_size + i] = remaining_point_indices[min_df]             # <<<<<<<<<<<<<<
 *         if lowest_df > -1e-8:
 *             break
 */
      (__pyx_v_trial_simplices[((__pyx_v_i * __pyx_v_simplex_size) + __pyx_v_i)]) = (__pyx_v_remaining_point_indices[__pyx_v_min_df]);
    }

    /* "pycalphad/core/hyperplane.pyx":255
 *         for i in range(simplex_size):
 *             trial_simplices[i*simplex_size + i] = remaining_point_indices[min_df]
 *         if lowest_df > -1e-8:             # <<<<<<<<<<<<<<
 *             break
 *     out_energy = 0
 */
    __pyx_t_10 = ((__pyx_v_lowest_df > -1e-8) != 0);
    if (__pyx_t_10) {

      /* "pycalphad/core/hyperplane.pyx":256
 *             trial_simplices[i*simplex_size + i] = remaining_point_indices[min_df]
 *         if lowest_df > -1e-8:
 *             break             # <<<<<<<<<<<<<<
 *     out_energy = 0
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":257
 *         if lowest_df > -1e-8:
 *             break
 *     out_energy = 0             # <<<<<<<<<<<<<<
 *     for i in range(simplex_size):
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":258
 *             break
 *     out_energy = 0
 *     for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *         idx = best_guess_simplex[i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":259
 *     out_energy = 0
 *     for i in range(simplex_size):
 *         idx = best_guess_simplex[i]             # <<<<<<<<<<<<<<
 *         out_energy += fractions[saved_trial*simplex_size + i] * energies[idx]
 *     for i in range(simplex_size):
 */
    __pyx_v_idx = (__pyx_v_best_guess_simplex[__pyx_v_i]);

    /* "pycalphad/core/hyperplane.pyx":260
 *     for i in range(simplex_size):
 *         idx = best_guess_simplex[i]
 *         out_energy += fractions[saved_trial*simplex_size + i] * energies[idx]             # <<<<<<<<<<<<<<
 *     for i in range(simplex_size):
 ...
 */
    __pyx_t_6 = __pyx_v_idx;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_energies.shape[0];
    __pyx_v_out_energy = (__pyx_v_out_energy + ((__pyx_v_fractions[((__pyx_v_saved_trial * __pyx_v_simplex_size) + __pyx_v_i)]) * (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_energies.data) + __pyx_t_6)) )))));
  }

  /* "pycalphad/core/hyperplane.pyx":261
 *         idx = best_guess_simplex[i]
 *         out_energy += fractions[saved_trial*simplex_size + i] * energies[idx]
 *     for i in range(simplex_size):             # <<<<<<<<<<<<<<
 *         result_fractions[i] = fractions[saved_trial*simplex_size + i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":262
 *         out_energy += fractions[saved_trial*simplex_size + i] * energies[idx]
 *     for i in range(simplex_size):
 *         result_fractions[i] = fractions[saved_trial*simplex_size + i]             # <<<<<<<<<<<<<<
 *     for ici in range(simplex_size):
 ...
 */
    __pyx_t_6 = __pyx_v_i;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_result_fractions.shape[0];
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_result_fractions.data) + __pyx_t_6)) )) = (__pyx_v_fractions[((__pyx_v_saved_trial * __pyx_v_simplex_size) + __pyx_v_i)]);
  }

  /* "pycalphad/core/hyperplane.pyx":263
 *     for i in range(simplex_size):
 *         result_fractions[i] = fractions[saved_trial*simplex_size + i]
 *     for ici in range(simplex_size):             # <<<<<<<<<<<<<<
 *         chempot_idx = free_chempot_indices[ici]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pycalphad/core/hyperplane.pyx":264
 *         result_fractions[i] = fractions[saved_trial*simplex_size + i]
 *     for ici in range(simplex_size):
 *         chempot_idx = free_chempot_indices[ici]             # <<<<<<<<<<<<<<
 *         chemical_potentials[chempot_idx] = candidate_potentials[ici]
 ...
 */
    ...
    /* "pycalphad/core/hyperplane.pyx":265
 *     for ici in range(simplex_size):
 *         chempot_idx = free_chempot_indices[ici]
 *         chemical_potentials[chempot_idx] = candidate_potentials[ici]             # <<<<<<<<<<<<<<
 *         result_simplex[ici] = best_guess_simplex[ici]
 ...
 */
    __pyx_t_6 = __pyx_v_chempot_idx;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_chemical_potentials.shape[0];
    *((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_chemical_potentials.data) + __pyx_t_6)) )) = (__pyx_v_candidate_potentials[__pyx_v_ici]);

    /* "pycalphad/core/hyperplane.pyx":266
 *         chempot_idx = free_chempot_indices[ici]
 *         chemical_potentials[chempot_idx] = candidate_potentials[ici]
 *         result_simplex[ici] = best_guess_simplex[ici]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_6 = __pyx_v_ici;
    if (__pyx_t_6 < 0) __pyx_t_6 += __pyx_v_result_simplex.shape[0];
    *((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_result_simplex.data) + __pyx_t_6)) )) = (__pyx_v_best_guess_simplex[__pyx_v_ici]);
  }

  /* "pycalphad/core/hyperplane.pyx":269
 * 
 *     # Hack to enforce Gibbs phase rule, shape of result is comp+1, shape of hyperplane is comp
 ...
 * 
 */
  __pyx_t_16.data = __pyx_v_result_fractions.data;
  __pyx_t_16.memview = __pyx_v_result_fractions.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_16, 0);
  __pyx_t_1 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_16,
    __pyx_v_result_fractions.shape[0], __pyx_v_result_fractions.strides[0], __pyx_v_result_fractions.suboffsets[0],
    0,
    0,
    &__pyx_t_1,
    __pyx_v_simplex_size,
    0,
    0,
    1,
    0,
...

{
  ...
  /* "pycalphad/core/hyperplane.pyx":270
 *     # Hack to enforce Gibbs phase rule, shape of result is comp+1, shape of hyperplane is comp
 *     result_fractions[simplex_size:] = 0.0
 *     result_simplex[simplex_size:] = 0             # <<<<<<<<<<<<<<
 * 
 *     # 1-D
 */
  __pyx_t_17.data = __pyx_v_result_simplex.data;
  __pyx_t_17.memview = __pyx_v_result_simplex.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_17, 0);
  __pyx_t_1 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_17,
    __pyx_v_result_simplex.shape[0], __pyx_v_result_simplex.strides[0], __pyx_v_result_simplex.suboffsets[0],
    0,
    0,
    &__pyx_t_1,
    __pyx_v_simplex_size,
...

{
      ...
      {
          Py_ssize_t __pyx_temp_extent = __pyx_t_17.shape[0];
          Py_ssize_t __pyx_temp_idx;
          int *__pyx_temp_pointer = (int *) __pyx_t_17.data;
          for (__pyx_temp_idx = 0; __pyx_temp_idx < __pyx_temp_extent; __pyx_temp_idx++) {
  ...
  /* "pycalphad/core/hyperplane.pyx":273
 * 
 *     # 1-D
 ...
 */
  free(__pyx_v_remaining_point_indices);

  /* "pycalphad/core/hyperplane.pyx":274
 *     # 1-D
 *     free(remaining_point_indices)
 *     free(included_composition_indices)             # <<<<<<<<<<<<<<
 *     free(best_guess_simplex)
 ...
 */
  free(__pyx_v_included_composition_indices);

  /* "pycalphad/core/hyperplane.pyx":275
 *     free(remaining_point_indices)
 *     free(included_composition_indices)
 *     free(best_guess_simplex)             # <<<<<<<<<<<<<<
 *     free(free_chempot_indices)
 ...
 */
  free(__pyx_v_best_guess_simplex);

  /* "pycalphad/core/hyperplane.pyx":276
 *     free(included_composition_indices)
 *     free(best_guess_simplex)
 *     free(free_chempot_indices)             # <<<<<<<<<<<<<<
 *     free(candidate_simplex)
 *     free(int_tmp)
 */
  free(__pyx_v_free_chempot_indices);

  /* "pycalphad/core/hyperplane.pyx":277
 *     free(best_guess_simplex)
 *     free(free_chempot_indices)
 *     free(candidate_simplex)             # <<<<<<<<<<<<<<
 *     free(int_tmp)
 ...
 */
  free(__pyx_v_candidate_simplex);

  /* "pycalphad/core/hyperplane.pyx":278
 *     free(free_chempot_indices)
 *     free(candidate_simplex)
 *     free(int_tmp)             # <<<<<<<<<<<<<<
 *     free(candidate_potentials)
 ...
 */
  free(__pyx_v_int_tmp);

  /* "pycalphad/core/hyperplane.pyx":279
 *     free(candidate_simplex)
 *     free(int_tmp)
 *     free(candidate_potentials)             # <<<<<<<<<<<<<<
 *     free(smallest_fractions)
 *     free(driving_forces)
 */
  free(__pyx_v_candidate_potentials);

  /* "pycalphad/core/hyperplane.pyx":280
 *     free(int_tmp)
 *     free(candidate_potentials)
 *     free(smallest_fractions)             # <<<<<<<<<<<<<<
 *     free(driving_forces)
 *     # 2-D
 */
  free(__pyx_v_smallest_fractions);

  /* "pycalphad/core/hyperplane.pyx":281
 *     free(candidate_potentials)
 *     free(smallest_fractions)
 *     free(driving_forces)             # <<<<<<<<<<<<<<
 *     # 2-D
 ...
 */
  free(__pyx_v_driving_forces);

  /* "pycalphad/core/hyperplane.pyx":283
 *     free(driving_forces)
 *     # 2-D
 *     free(trial_simplices)             # <<<<<<<<<<<<<<
 *     free(fractions)
 *     free(f_contig_trial)
 */
  free(__pyx_v_trial_simplices);

  /* "pycalphad/core/hyperplane.pyx":284
 *     # 2-D
 *     free(trial_simplices)
 *     free(fractions)             # <<<<<<<<<<<<<<
 *     free(f_contig_trial)
 ...
 */
  free(__pyx_v_fractions);

  /* "pycalphad/core/hyperplane.pyx":285
 *     free(trial_simplices)
 *     free(fractions)
 *     free(f_contig_trial)             # <<<<<<<<<<<<<<
 *     free(f_candidate_tieline)
 *     # 3-D
 */
  free(__pyx_v_f_contig_trial);

  /* "pycalphad/core/hyperplane.pyx":286
 *     free(fractions)
 *     free(f_contig_trial)
 *     free(f_candidate_tieline)             # <<<<<<<<<<<<<<
 *     # 3-D
 *     free(f_trial_matrix)
 */
  free(__pyx_v_f_candidate_tieline);

  /* "pycalphad/core/hyperplane.pyx":288
 *     free(f_candidate_tieline)
 *     # 3-D
 *     free(f_trial_matrix)             # <<<<<<<<<<<<<<
 * 
 *     return out_energy
 */
  free(__pyx_v_f_trial_matrix);

  /* "pycalphad/core/hyperplane.pyx":290
 *     free(f_trial_matrix)
 * 
 *     return out_energy             # <<<<<<<<<<<<<<
 */
  __pyx_r = __pyx_v_out_energy;
  goto __pyx_L0;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_17, 0);
  {
    ...
    #endif
    __Pyx_AddTraceback("pycalphad.core.hyperplane.hyperplane", __pyx_clineno, __pyx_lineno, __pyx_filename);
    #ifdef WITH_THREAD
...
static PyObject *__pyx_pw_9pycalphad_4core_10hyperplane_1hyperplane(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_compositions,&__pyx_n_s_energies,&__pyx_n_s_composition,&__pyx_n_s_chemical_potentials,&__pyx_n_s_total_moles,&__pyx_n_s_fixed_chempot_indices,&__pyx_n_s_fixed_comp_indices,&__pyx_n_s_result_fractions,&__pyx_n_s_result_simplex,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_compositions)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_energies)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 1); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_composition)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 2); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_chemical_potentials)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 3); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_total_moles)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 4); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fixed_chempot_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 5); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fixed_comp_indices)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 6); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  7:
        if (likely((values[7] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_result_fractions)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 7); __PYX_ERR(0, 60, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  8:
        if (likely((values[8] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_result_simplex)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, 8); __PYX_ERR(0, 60, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "hyperplane") < 0)) __PYX_ERR(0, 60, __pyx_L3_error)
      }
    ...
    __pyx_v_compositions = __Pyx_PyObject_to_MemoryviewSlice_d_dc_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_compositions.memview)) __PYX_ERR(0, 60, __pyx_L3_error)
    __pyx_v_energies = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_energies.memview)) __PYX_ERR(0, 61, __pyx_L3_error)
    __pyx_v_composition = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_composition.memview)) __PYX_ERR(0, 62, __pyx_L3_error)
    __pyx_v_chemical_potentials = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_chemical_potentials.memview)) __PYX_ERR(0, 63, __pyx_L3_error)
    __pyx_v_total_moles = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_total_moles == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 64, __pyx_L3_error)
    __pyx_v_fixed_chempot_indices = __Pyx_PyObject_to_MemoryviewSlice_dc_size_t(values[5], PyBUF_WRITABLE); if (unlikely(!__pyx_v_fixed_chempot_indices.memview)) __PYX_ERR(0, 65, __pyx_L3_error)
    __pyx_v_fixed_comp_indices = __Pyx_PyObject_to_MemoryviewSlice_dc_size_t(values[6], PyBUF_WRITABLE); if (unlikely(!__pyx_v_fixed_comp_indices.memview)) __PYX_ERR(0, 66, __pyx_L3_error)
    __pyx_v_result_fractions = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[7], PyBUF_WRITABLE); if (unlikely(!__pyx_v_result_fractions.memview)) __PYX_ERR(0, 67, __pyx_L3_error)
    __pyx_v_result_simplex = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[8], PyBUF_WRITABLE); if (unlikely(!__pyx_v_result_simplex.memview)) __PYX_ERR(0, 68, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("hyperplane", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 60, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("pycalphad.core.hyperplane.hyperplane", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9pycalphad_4core_10hyperplane_hyperplane(__pyx_self, __pyx_v_compositions, __pyx_v_energies, __pyx_v_composition, __pyx_v_chemical_potentials, __pyx_v_total_moles, __pyx_v_fixed_chempot_indices, __pyx_v_fixed_comp_indices, __pyx_v_result_fractions, __pyx_v_result_simplex);
...
static PyObject *__pyx_pf_9pycalphad_4core_10hyperplane_hyperplane(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_compositions, __Pyx_memviewslice __pyx_v_energies, __Pyx_memviewslice __pyx_v_composition, __Pyx_memviewslice __pyx_v_chemical_potentials, double __pyx_v_total_moles, __Pyx_memviewslice __pyx_v_fixed_chempot_indices, __Pyx_memviewslice __pyx_v_fixed_comp_indices, __Pyx_memviewslice __pyx_v_result_fractions, __Pyx_memviewslice __pyx_v_result_simplex) {
  ...
  if (unlikely(!__pyx_v_compositions.memview)) { __Pyx_RaiseUnboundLocalError("compositions"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_energies.memview)) { __Pyx_RaiseUnboundLocalError("energies"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_composition.memview)) { __Pyx_RaiseUnboundLocalError("composition"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_chemical_potentials.memview)) { __Pyx_RaiseUnboundLocalError("chemical_potentials"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_fixed_chempot_indices.memview)) { __Pyx_RaiseUnboundLocalError("fixed_chempot_indices"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_fixed_comp_indices.memview)) { __Pyx_RaiseUnboundLocalError("fixed_comp_indices"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_result_fractions.memview)) { __Pyx_RaiseUnboundLocalError("result_fractions"); __PYX_ERR(0, 60, __pyx_L1_error) }
  if (unlikely(!__pyx_v_result_simplex.memview)) { __Pyx_RaiseUnboundLocalError("result_simplex"); __PYX_ERR(0, 60, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_9pycalphad_4core_10hyperplane_hyperplane(__pyx_v_compositions, __pyx_v_energies, __pyx_v_composition, __pyx_v_chemical_potentials, __pyx_v_total_moles, __pyx_v_fixed_chempot_indices, __pyx_v_fixed_comp_indices, __pyx_v_result_fractions, __pyx_v_result_simplex, 0); if (unlikely(__pyx_t_1 == ((double)-1) && PyErr_Occurred())) __PYX_ERR(0, 60, __pyx_L1_error)
  ...
  __pyx_r = NULL;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_compositions, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_energies, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_composition, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_chemical_potentials, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_fixed_chempot_indices, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_fixed_comp_indices, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_result_fractions, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_result_simplex, 1);
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "pycalphad.core.hyperplane.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "pycalphad.core.hyperplane.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "pycalphad.core.hyperplane.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "pycalphad.core.hyperplane._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"hyperplane", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_9pycalphad_4core_10hyperplane_1hyperplane, METH_VARARGS|METH_KEYWORDS, __pyx_doc_9pycalphad_4core_10hyperplane_hyperplane},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_hyperplane(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_hyperplane},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_chemical_potentials, __pyx_k_chemical_potentials, sizeof(__pyx_k_chemical_potentials), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_fixed_chempot_indices, __pyx_k_fixed_chempot_indices, sizeof(__pyx_k_fixed_chempot_indices), 0, 0, 1, 1},
  {&__pyx_n_s_fixed_comp_indices, __pyx_k_fixed_comp_indices, sizeof(__pyx_k_fixed_comp_indices), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_result_fractions, __pyx_k_result_fractions, sizeof(__pyx_k_result_fractions), 0, 0, 1, 1},
  {&__pyx_n_s_result_simplex, __pyx_k_result_simplex, sizeof(__pyx_k_result_simplex), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_total_moles, __pyx_k_total_moles, sizeof(__pyx_k_total_moles), 0, 0, 1, 1},
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("hyperplane", (void (*)(void))__pyx_f_9pycalphad_4core_10hyperplane_hyperplane, "double (__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
__Pyx_PyMODINIT_FUNC inithyperplane(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC inithyperplane(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_hyperplane(void) CYTHON_SMALL_CODE; /*proto*/
__Pyx_PyMODINIT_FUNC PyInit_hyperplane(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_hyperplane(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'hyperplane' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #elif PY_MAJOR_VERSION >= 3
...
if (!__Pyx_RefNanny) {
...
#endif
  __Pyx_RefNannySetupContext("__Pyx_PyMODINIT_FUNC PyInit_hyperplane(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("hyperplane", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_pycalphad__core__hyperplane) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "pycalphad.core.hyperplane")) {
      if (unlikely(PyDict_SetItemString(modules, "pycalphad.core.hyperplane", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "pycalphad/core/hyperplane.pyx":3
 ...
 */
  ...
  /* "pycalphad/core/hyperplane.pyx":1
 * # distutils: language = c++             # <<<<<<<<<<<<<<
 * cimport numpy as np
 * import numpy as np
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init pycalphad.core.hyperplane", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pycalphad.core.hyperplane");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
